        ...
        do
            ...
            do
                ...
                do
                    ...
                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_gc_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_GCLog.txt ${jmeter_gc_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_GCLog.txt

                    gc_log_for_this=${jmeter_gc_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_GCLog.txt

                    echo "Generating GC Reports"

                    gc_report_file_for_this=${jmeter_gc_logs_report_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_GCReport.csv

                    java -jar $jmeter_gc_viewer_jar_file $gc_log_for_this $gc_report_file_for_this
#
                    echo "Downloading CPU SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_cpu_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_cpu_sar.txt

                    cpu_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_cpu_sar.txt

                    echo "Downloading Memory SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_memory_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_memory_sar.txt

                    memory_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_memory_sar.txt

                    echo "Downloading Swap SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_swap_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_swap_sar.txt

                    swap_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_swap_sar.txt

                    echo "Downloading IO SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_io_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_io_sar.txt

                    io_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_io_sar.txt

                    echo "Downloading INode SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_inode_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_inode_sar.txt

                    inode_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_inode_sar.txt

                    echo "Downloading Context Switch SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_context_switch_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_context_switch_sar.txt

                    context_switch_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_context_switch_sar.txt

                    echo "Downloading Run Queue SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_run_queue_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_run_queue_sar.txt

                    run_queue_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_run_queue_sar.txt

                    echo "Downloading Network SAR"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_network_sar.txt ${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_network_sar.txt

                    network_sar_file_for_this=${jmeter_sar_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_network_sar.txt

                    echo "Downloading Perf"

                    sshpass -p 'javawso2' scp -r ${backend_host_user}@${backend_host_ip}:${backend_perf_path}/${backend_program_jar}-1.0-SNAPSHOT.jar/io/${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_perf.txt ${jmeter_perf_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_perf.txt

                    perf_file_for_this=${jmeter_perf_path}/${backend_program_jar}-1.0-SNAPSHOT.jar_io_${heap}_Heap_${u}_Users_${gc}_collector_${size}_size_perf.txt
